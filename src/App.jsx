...
function App() {
  ...
  if (isLoggedIn) {
    return <main className="dashboard-page"><nav className="topbar"><a href="/" className="brand"><span className="brand-mark">d</span>dayflow</a><button className="secondary-button" onClick={() => setIsLoggedIn(false)}>Sign out</button></nav><section className="dashboard-content"><p className="eyebrow">Monday, August 22, 2026</p><h1>Good morning, Alex.</h1><p className="muted">Your workspace is ready. Here is a clear start to your day.</p><div className="dashboard-grid"><article className="dashboard-card focus-card"><span>Today's focus</span><strong>Make space for good work.</strong><small>Plan your priorities and keep your momentum visible.</small></article><article className="dashboard-card"><span>Team status</span><strong>All systems flowing</strong><small>12 teammates are active today.</small></article><article className="dashboard-card"><span>Quick start</span><strong>Set your first priority</strong><small>Turn a clear intention into progress.</small></article></div></section><AttendanceTracking /></main>
  }
